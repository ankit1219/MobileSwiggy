...
//          AndroidDriver driver = new AndroidDriver(URL, caps);
            ...
            driver.findElement(By.id("in.swiggy.android:id/tv_phone_umber")).sendKeys("7011026289");
            driver.findElement(By.id("in.swiggy.android:id/full_width_button_label")).click();
...
String PriceafterAddToCart = driver.findElement(By.xpath("(//android.widget.TextView[@content-desc=\"price ₹320 rupees\"])[1]"))
        .getAttribute("text");
